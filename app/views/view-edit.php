...
<div class="breadcrumbwidget">
	<ul class="breadcrumb">
		...
		<li class="active"><?php echo '<?php echo _(\'Edit\'); ?>' ?></li>
	</ul>
</div><!--breadcrumbs-->
<div class="pagetitle">
	<div class="row-fluid">
		<div class="span6"><h1><?php echo '<?php echo _(\'', $controller, '\'); ?>' ?></h1><span><?php echo '<?php echo _(\'Edit existing data\'); ?>' ?></span></div>
		<div class="span6">
...
<div class="maincontent">
	<div class="contentinner">
		...
		<form action="<?php echo '<?php echo $service_base_url; ?>' ?>/save" class="stdform stdform2" id="<?php echo String::toLowerCase($controller) ?>" method="post">
			...
			<h4 class="widgettitle nomargin shadowed"><?php echo '<?php echo _(\'Edit ', $controller, '\'); ?>' ?></h4>
